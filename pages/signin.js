  ...
  useEffect(() => {
    ...
    return(
      <div>
        ...
        <h1 style={{ textAlign: "left", marginLeft: "5rem", fontWeight: "bold"}}>
          Iniciar sesión
        </h1>
        <hr style={{width:"90%", border: "1px solid"}}/>
        <form className="mx-auto signin-form" style={{maxWidth: '500px', margin:"13rem 0"}} onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn sign" style={{width:"8rem"}}>Entrar</button>          
        </form>
      </div>
    )
  }
